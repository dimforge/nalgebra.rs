...
where
    D: Dim,
    DefaultAllocator: nalgebra::base::allocator::Allocator<f64, D>,
{
    x + y
}
...
where
    D: Dim,
    DefaultAllocator: base::allocator::Allocator<f64, D, D>,
{
    for elt in input {
        println!("{}", elt);
    }
...
where
    R: Dim,
    C: Dim,
    DefaultAllocator: nalgebra::base::allocator::Allocator<f64, R, C>,
{
    for elt in input {
        println!("{}", elt);
    }
...
where
    D: Dim,
    DefaultAllocator: nalgebra::base::allocator::Allocator<f64, D>,
    DefaultAllocator: nalgebra::base::allocator::Allocator<f64, D, D>,
{
    for elt in vector {
        println!("{}", elt);
    }
