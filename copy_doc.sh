...
cd $nalgebra_dir; rm -r target/doc; cargo doc -p nalgebra --no-deps --features "arbitrary serde-serialize abomonation"
cd -
rm -rf docs/rustdoc
...
cd $nalgebra_dir; rm -r target/doc; cargo doc -p nalgebra-glm --no-deps --features "arbitrary serde-serialize abomonation"
cd -
